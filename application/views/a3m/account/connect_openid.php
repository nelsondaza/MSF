...
<html>
<head>
	<?php echo $this->load->view('a3m/head', array('title' => sprintf(lang('connect_with_x'), lang('connect_openid')))); ?>

</head>
<body>

<?php echo $this->load->view('a3m/header'); ?>
...
<?php echo $this->load->view('a3m/footer'); ?>