...
class Connect_openid extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->load->helper(array('language', 'account/ssl', 'url', 'account/openid', 'photo'));
		$this->load->library(array('account/authentication', 'account/authorization'));
		$this->load->model(array('account/account_model', 'account/account_details_model', 'account/account_openid_model'));
