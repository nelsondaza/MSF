...
class Connect_create extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->load->model(array('account/account_model', 'account/account_details_model', 'account/account_facebook_model', 'account/account_google_model', 'account/account_twitter_model', 'account/account_openid_model'));
