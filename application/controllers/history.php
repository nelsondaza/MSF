	...
	class History extends GeneralController {
		...
		function index( $id ) {
			...
			$this->load->model( array(
				...
				'manage/closures_model',
				'manage/closures_conditions_model',
			...
			$data['symptoms_categories'] = $this->symptoms_categories_model->getActiveList();
			$data['diagnostics'] = $this->diagnostics_model->getActiveList();
			$data['risks'] = $this->risks_model->getActiveList();
			$data['risks_categories'] = $this->risks_categories_model->getActiveList();
